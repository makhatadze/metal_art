            ...
            <div class="intro-y box p-5">
                ...
                <div class="sm:grid grid-cols-4 gap-4 mb-4">
                    ...
                    <div class="relative mt-4 {{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('phone', '', ['class' => 'input w-full border mt-2 col-span-2', 'no']) }}
                        @if ($errors->has('phone'))
                            <span class="help-block">
                                            {{ $errors->first('phone') }}
                                        </span>
                ...
                <div class="sm:grid grid-cols-4 gap-4 mb-4">
                    ...
                    <div class="relative mt-4">
                        ...
                        <div class="mt-2">
                            <select data-placeholder="აირჩიეთ წვის ტიპი"
                                    name="fuel"
                                    class="font-helvetica select2 w-full">
                ...
                <div class="sm:grid grid-cols-5 gap-5 mb-2">
                    ...
                    <div class="relative mt-4 {{ $errors->has('wheel') ? ' has-error' : '' }}">
                        {{ Form::label('wheel', 'საჭე', ['class' => 'font-helvetica']) }}
                    ...
                    <div class="relative mt-4 {{ $errors->has('drive') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('drive', '', ['class' => 'input w-full border mt-2 col-span-2', 'no']) }}
                        @if ($errors->has('drive'))
                            <span class="help-block">
                                            {{ $errors->first('drive') }}
                                        </span>
