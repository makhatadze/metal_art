            ...
            <div class="intro-y box p-5">
                ...
                <div class="sm:grid grid-cols-3 gap-3 mb-4">
                    <div class="relative mt-4 {{ $errors->has('title_ge') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('title_ge', $category->title_ge, ['class' => 'input w-full border mt-2 col-span-2', 'no']) }}
                    ...
                    <div class="relative mt-4 {{ $errors->has('title_en') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('title_en', $category->title_en, ['class' => 'input w-full border mt-2 col-span-2']) }}
                    ...
                    <div class="relative mt-4 {{ $errors->has('title_ru') ? ' has-error' : '' }}">
                        {{ Form::label('title_ru', 'სახელი ინგლისურად', ['class' => 'font-helvetica']) }}
                        {{ Form::text('title_ru', $category->title_en, ['class' => 'input w-full border mt-2 col-span-2']) }}
