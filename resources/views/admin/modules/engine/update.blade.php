        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="intro-y box p-5">
                ...
                <div class="relative mt-4 {{ $errors->has('title_ge') ? ' has-error' : '' }}">
                    ...
                    {{ Form::text('title_ge', $engine->title_ge, ['class' => 'input w-full border mt-2 col-span-2', 'no']) }}
                    ...
                    <div class="relative mt-4 {{ $errors->has('title_en') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('title_en', $engine->title_en, ['class' => 'input w-full border mt-2 col-span-2', 'no']) }}
