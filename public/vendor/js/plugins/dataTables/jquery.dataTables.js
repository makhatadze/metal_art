...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 * previous, first or last modules.
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of modules of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} modules` The number of modules in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, modules ) {
